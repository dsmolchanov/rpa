...
Capability → proof map (each row is backed by named preflight checks; 64 checks total):
...
- score (blind scorer): `runner.py --config C --score --docs D1.md D2.md --judge-prompt J.md --scoring-seed S`
