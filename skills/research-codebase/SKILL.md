...
| Artifact schema | every document | self-check against `references/artifact-contract.md` | before finishing | blocking | frontmatter fields + section headings present |
