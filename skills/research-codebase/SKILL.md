...
Discovery & invocation (conventions §2.0): user- and model-invocable;
permission class **read_only** on the target repo plus **workspace_write**
limited to `thoughts/shared/research/`.
